...
class Objetivo06Teste(unittest.TestCase):
    ...
    #
    # Critério: Não deve vencer o jogo.
    def test_DadoQueOJogador1FoiEliminadoMasNaoFoiPeloJogador3_DadoJogador3Tem2Territorios_EntaoJogador3NaoVenceOJogo(self):
        # Preparação.
        self.jogador3.jogadoresDestruidos = []
    ...
    #
    # Critério: Deve vencer o jogo.
    def test_DadoQueOJogador1FoiEliminadoMasNaoFoiPeloJogador3_DadoJogador3Tem24Territorios_EntaoJogador3VenceOJogo(self):
        # Preparação.
        self.jogador3.jogadoresDestruidos = []
