...
class Objetivo03Teste(unittest.TestCase):
    ...
    #
    # Critério: Não deve vencer o jogo.
    def test_DadoQueOJogador5FoiEliminadoMasNaoFoiPeloJogador1_DadoJogador1Tem2Territorios_EntaoJogador1NaoVenceOJogo(
            self):
        # Preparação.
        self.jogador1.jogadoresDestruidos = []
    ...
    #
    # Critério: Deve vencer o jogo.
    def test_DadoQueOJogador5FoiEliminadoMasNaoFoiPeloJogador1_DadoJogador1Tem24Territorios_EntaoJogador1VenceOJogo(
            self):
        # Preparação.
        self.jogador1.jogadoresDestruidos = []
