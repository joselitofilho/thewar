...
class Objetivo03Teste(unittest.TestCase):
    ...
    # Cenário:
    #   * Jogador1 tem o objetivo 03;
    #   * Jogador1 eliminou o Jogador5.
    #
    # Critério: Deve vencer o jogo.
    def test_DadoQueOJogador1EliminouOJogador5_EntaoJogador1VenceOJogo(self):
        # Preparacao.
        self.jogador1.jogadoresDestruidos = [4]
        
        # Operacao.
        venceu = Objetivo03().completou(self.jogador1, self.jogadores)
    ...
    # Cenário:
    #   * Jogador1 tem o objetivo 03;
    #   * Jogador5 não doi eliminado do jogo.
    #
    # Critério: Não deve vencer o jogo.
    def test_DadoQueOJogador5NaoFoiEliminadoDoJogo_EntaoJogador1NaoVenceOJogo(self):
        # Preparação.
    ...
    # Cenário:
    #   * Jogador1 tem o objetivo 03;
    #   * Jogador5 foi eliminado mas não foi pelo Jogador1;
    #   * Jogador1 tem 2 territorios.
    #
    # Critério: Não deve vencer o jogo.
    def test_DadoQueOJogador5FoiEliminadoMasNaoFoiPeloJogador1_DadoJogador1Tem2Territorios_EntaoJogador1NaoVenceOJogo(self):
        # Preparação.
        self.jogador1.jogadoresDestruidos = []
    ...
    #
    # Critério: Deve vencer o jogo.
    def test_DadoQueOJogador5FoiEliminadoMasNaoFoiPeloJogador1_DadoJogador1Tem24Territorios_EntaoJogador1VenceOJogo(self):
        # Preparação.
        self.jogador1.jogadoresDestruidos = []
    ...
    # Cenário:
    #   * Jogador1 tem o objetivo 03;
    #   * Jogador5 não está no jogo;
    #   * Jogador1 tem 2 territorios.
    #
    # Critério: Não deve vencer o jogo.
    def test_DadoQueOJogador5NaoEstaNoJogo_DadoJogador1Tem2Territorios_EntaoJogador1NaoVenceOJogo(self):
        # Preparação.
        self.jogador1.jogadoresDestruidos = []
        self.jogador1.iniciaTerritorios(self.codigosTerritorios_2)
        
        del self.jogadores[4]
    ...
    #
    # Critério: Deve vencer o jogo.
    def test_DadoQueOJogador5NaoEstaNoJogo_DadoJogador1Tem24Territorios_EntaoJogador1VenceOJogo(self):
        # Preparação.
        self.jogador1.jogadoresDestruidos = []
        self.jogador1.iniciaTerritorios(self.codigosTerritorios_24)
