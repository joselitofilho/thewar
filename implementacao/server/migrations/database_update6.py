...
with con:
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS DesafiosEmAndamento(idDesafio INTEGER NOT NULL, nomeOrientador TEXT NOT NULL, infos TEXT DEFAULT '{}', apenasDoador BOOLEAN DEFAULT TRUE, iniciaEm DATETIME NOT NULL, terminaEm DATETIME NOT NULL)")
